  ...
  <div class="wrapper">
         <el-form :model="form" :rules="rules" ref="form" label-width="100px" class="demo-userForm" :inline="true" :disabled="isView">
            ...
            <el-form-item label="课程" prop="courseNumber">
                    <el-select v-model="form.courseNumber" class="m-2" placeholder="请选择课程" size="default" filterable disabled>
                        <el-option
            ...
            <el-form-item label="学生" prop="stuNumber">
                    <el-select v-model="form.stuNumber" class="m-2" placeholder="Select" size="default" filterable disabled>
                        <el-option
  ...
  methods:{
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
                ...
                this.axios.put('/Score/'+ this.id,data).then((response) => {
                    response
                    this.$message({
                        message: '保存成功',
                        type: 'success'
      ...
      getObjData(){
         this.axios.get('/Score/'+this.id,{}).then((response) => {
                    response
